...
const Login = () => {
    ...
    return (
        <div>
            <div class="bg-slate-900 md:h-screen">
                <div class="grid md:grid-cols-2 items-center gap-8 h-full">
                    ...
                    <div class="flex items-center md:p-8 p-6 bg-white md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
                        <form class="max-w-lg w-full mx-auto">
                            <div class="mb-12">
                                <h3 class="text-slate-900 text-4xl font-bold">
                                    Sign in
                                </h3>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input
                                            ...
                                            type="text"
                                            required
                                            class="w-full text-sm border-b border-slate-300 focus:border-slate-800 pl-2 pr-8 py-3 outline-none"
                            ...
                            <div class="mt-12">
                                <button
                                    type="button"
                                    onClick={onLogin}
                                    class="w-full py-3 px-6 text-sm font-medium cursor-pointer tracking-wider rounded-full text-white bg-slate-800 hover:bg-slate-900 focus:outline-none">
                                    Sign in
                                </button>
                            </div>
                        </form>
